...
<head runat="server">
    <title>MSquare: Login</title>
    <link href="Content/bootstrap.css" rel="stylesheet" />
    <link href="Content/style.css" rel="stylesheet" />
    <link href="Content/font-awesome.css" rel="stylesheet" />
    <link href="Content/icheck-bootstrap.css" rel="stylesheet" />
</head>
<body class="hold-transition login-page" style="background-image: url('0.jpg');">
-
    <form id="form1" runat="server">
        <div class="login-box">
            <div class="login-logo" style="color: #FF0000; font-family: 'book Antiqua'">
                <a><b style="color: #FF0000">MSquare Login</b></a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                      ...
                      <div class="col-xs-8">
                        <a href="Register.aspx" class="btn btn-primary btn-block btn-flat">Sign Up</a>
