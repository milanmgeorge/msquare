...
<head runat="server">
     <title>MSquare: Register</title>
    <link href="Content/bootstrap.css" rel="stylesheet" />
    <link href="Content/style.css" rel="stylesheet" />
    <link href="Content/icheck-bootstrap.css" rel="stylesheet" />
    <link href="Content/font-awesome.css" rel="stylesheet" />
</head>
<body class="hold-transition register-page" style="background-image: url('0.jpg');">
    <form id="form1" runat="server">

        <div class="register-box">
  <div class="register-logo" style="color: #FF0000; font-family: 'Book Antiqua'; font-style: normal">
    <a style="color: #FF0000"><b>MSquare Sign Up</b></a>
  </div>
